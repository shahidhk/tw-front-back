...
const resolvers = {
  ...
  Mutation: {
    insert_reconciliation_view: async (_, { objects }) => {
      ...
      var role_criticality =
        typeof objects.role_criticality === "undefined"
          ? 1
          : objects.role_criticality;
      var role_name = objects.role_name;
      var role_priority =
        typeof objects.role_priority === "undefined"
          ? 1
          : objects.role_priority;
      var role_spatial_site_id =
        typeof objects.role_spatial_site_id === "undefined"
          ? 1
          : objects.role_spatial_site_id;
      return await postData(djangoAPIENDpoint + "/missing-role/", {
        role_number,
        role_spatial_site_id,
        role_priority,
        role_name,
        role_criticality,
        parent_id
    ...
    insert_unassigned_assets: async (_, { objects }) => {
      ...
      return await postData(djangoAPIENDpoint + "/missing-asset/", {
        asset_serial_number
      });
    },
    update_unassigned_assets: async (_, { where, _set }) => {
      ...
      return await postData(djangoAPIENDpoint + "/assign-asset-to-role/", {
        asset_id,
        role_id
      });
    },
    update_reconciliation_view: async (_, { where, _set }) => {
      ...
      if (_set.role_id !== undefined) {
        //this might not be getting used
        var asset_id = where.id._eq;
        var role_id = _set.role_id;
        return await postData(djangoAPIENDpoint + "/assign-asset-to-role/", {
          asset_id,
        ...
        return await postData(djangoAPIENDpoint + "/entity-exists/", {
          entity_exists,
          role_id
        });
        ...
        return await postData(djangoAPIENDpoint + "/set-role-parent/", {
          parent_id,
          role_id
        });
